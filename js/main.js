...
function applyConfig() {
    ...
    // Profile Image - We removed the <img> to avoid 404, but we can re-add it if URL exists
    // For now, we are using the code snippet card in HTML as the hero visual
    // If you want the profile image back, uncomment below:
    /*
    const profileImg = document.getElementById('profile-img');
    if (profileImg && config.personal.avatar) {
         profileImg.src = config.personal.avatar;
